    ...
    <div class="col-md-12">
        ...
        <div class="portlet box green">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-cogs"></i>Geçmiş Oylamalar
                </div>
                <div class="tools">
            ...
            <div class="portlet-body">
                ...
                $sql_oylama = "SELECT * FROM `oylama` WHERE ref_apartman_id = ".$_SESSION['apartman_id']." AND `end_date` < '$now' ";
