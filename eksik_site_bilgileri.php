               ...
               <div class="portlet box blue-hoki">
                  ...
                  <div class="portlet-body">
                     <div class="scroller" style="height:50px" data-rail-visible="1" data-rail-color="yellow" data-handle-color="#a1b2bd">
                        Eğer sitede oturmuyorsanız sakin olun -DON'T PANİC- apartman bilgilerinizi girerek devam edin.
                        (42)
                     </div>
                  </div>
               </div>
         ...
         <div class="col-md-10">
   			 <div class="portlet box blue-hoki">
		         ...
		         <div class="portlet-body form">
		            <!-- BEGIN FORM-->
		            <form action="eksik_site_kayit.php" class="horizontal-form" method="post">
		               <div class="form-body">
		                  <h3 class="form-section">Site Bilgileri</h3>
		                  <div class="row">
		                     <div class="col-md-6 ">
		                  ...
		                  <div class="row">
		                    ...
		                    <div class="col-md-6">
		                        <div class="form-group">
		                           ...
		                           <input type="number" class="form-control" name= "posta_kodu">
		                        </div>
		                     </div>
		                  </div>
		              	</div>
