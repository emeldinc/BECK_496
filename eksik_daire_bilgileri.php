         ...
         <div class="col-md-10">
             <div class="portlet box blue-hoki">
               ...
               <div class="portlet-body form">
                  <!-- BEGIN FORM-->
                  <form action="eksik_daire_kayit" class="horizontal-form" method="post">
                     <div class="form-body">
                        <h3 class="form-section">Daire Bilgileri</h3>
                        <div class="row">
                           <label class="col-md-2 control-label" for="form_control_1">Apartman</label>
                              <div class="col-md-10">
                                 <div class="form-group">
                                    <?php include('dbconnection.php'); 
                                    $sql = "SELECT * FROM beckdoor.apartman";
